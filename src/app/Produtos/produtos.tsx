                ...
                <section className="produtos">
                    ...
                    <div className="conteudo_produtos">
                        ...
                        <div className="txt_produtos">
                            <Image src="/imagens/img_customer.png" alt="Logo customer 360" width={400} height={65}></Image>
                        ...
                        <Image className="img_produtos" src="/imagens/img_produtos.png" alt="Imagem do costumer 360 em volta de uma mulher" width={500} height={500}></Image>
