                ...
                <div className="container_produtos">
                    <div className="conteudo_produtos">
                        ...
                        <div className="txt_produtos">
                            ...
                            <TextToSpeech text="O Customer 360 da Salesforce é uma plataforma que reúne informações de clientes
                                ...
                                melhorando seus relacionamentos e impulsionando o engajamento."></TextToSpeech>
